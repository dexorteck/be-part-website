...
export default function Hero() {
  ...
  return (
    <section className={`relative min-h-[100vh] min-h-[100dvh] h-[100vh] h-[100dvh] sm:min-h-screen sm:h-screen flex items-center justify-center bg-gray-900 overflow-hidden py-10 sm:py-16 hero-mobile-optimized ${viewportClass}`}>
      ...
      <div className="relative z-10 max-w-3xl sm:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col justify-center h-full hero-content">
        <div className="space-y-6 sm:space-y-8">
          {/* Fingerprint Animation - Positioned above title */}
          <div className="mb-4 sm:mb-6 -mt-6 sm:mt-0 relative z-10 hero-fingerprint fingerprint-container">
            <FingerprintAnimation />
          </div>

          {/* Main Headline */}
          <div className="space-y-2 sm:space-y-4 relative z-20 hero-title">
          ...
          {/* Subheadline */}
          <div className="max-w-2xl mx-auto pt-2 sm:pt-4 relative z-20 hero-title">
          ...
          {/* CTA Button - Aumentado espaçamento em dispositivos portáteis */}
          <div className="pt-6 sm:pt-8 pb-8 sm:pb-12 cta-button-mobile relative z-20 hero-title">
      ...
      {/* Scroll Indicator - Melhorado posicionamento e visibilidade */}
      <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 z-20 scroll-indicator-mobile">
