  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gray-900 overflow-hidden py-16">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-brand-teal-light/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-brand-teal-dark/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            {/* Original serif version: <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif font-bold leading-tight"> */}
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-brand font-bold leading-tight">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="flex flex-col items-center space-y-2 text-gray-400">
          ...
          <div className="w-px h-8 bg-gradient-to-b from-brand-teal-light to-transparent"></div>
        </div>
      </div>
    </section>
  )
